...
public class MouseHit : MonoBehaviour
{
    ...
    public Vector3 MousePos
    {
        get
        {
            ...
            return Physics.Raycast(Camera.main.ScreenPointToRay(Input.mousePosition), out RaycastHit hit, float.PositiveInfinity, LayerMask.GetMask(targetLayerName)) ?
    ...
    /// </summary>
    public static explicit operator Vector3(MouseHit hit)
    {
        return hit.MousePos;
    }
}